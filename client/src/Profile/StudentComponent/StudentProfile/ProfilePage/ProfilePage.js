...
function ProfilePage({ studentData }) {
  ...
  return (
    <>
      <div className="section">
        ...
        <div className="container section4">
          <div className="row">
            {personalDeatils && <PersonalDeatils studentData={studentData} />}
            {familyDeatils && <FamilyDeatils studentData={studentData} />}
            {acadmicDetails && <AcadmicDetails studentData={studentData} />}
          </div>
        </div>
      </div>
    </>
